...
//addition by me for combining rsa and digi
...
public class RSA_digi_signing {
    ...
    public RSA_digi_signing(int primeSize,String msg) throws Exception {
        ...
        byte[] data = inputMessage.getBytes("UTF8");
       ...
       System.out.println("");
        encryptedData = RSAencrypt(inputMessage+new BASE64Encoder().encode(signatureBytes));
     ...
     */
    public  String maine() throws Exception{
       
        //System.out.println("msg got:"+inputMessage);
